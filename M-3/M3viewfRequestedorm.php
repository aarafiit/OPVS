...
<body>
    ...
    <div class="content" style="margin-left: 2%;padding: 135px;margin-top: -20px;">
        <?php
        ...
        // $institute = $_SESSION['ins_email'];
        if(isset($_GET['param'])){
            $formId = $_GET['param'];
            
        }

        // echo "<script>alert('jhlbhsd'); </script>";
