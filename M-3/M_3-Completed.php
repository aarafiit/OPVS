  ...
  <div class="sidebar">
    ...
    <div class="content">
        <table>
            ...
            $sql = "SELECT * FROM form_info WHERE (form_info.status != 'institute' or form_info.status != 'police' or form_info.status != 'officer' or form_info.status != 'rejected by institute' or form_info.status != 'rejected by SB' or form_info.status != 'rejected by institute' or form_info.status != 'requestor')";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td>
                            ...
                            <button class="decline-button" style="background-color: black; color : white;" onclick = "redirectToAnotherPage3('.$formId.')">View</button>                 
...
function redirectToAnotherPage3(parameter) {
    // Specify the URL of the page you want to navigate to and include the form ID as a parameter
        // var newPageUrl = '/M-3/M3viewCompleted.php';
