...
<body>
    ...
    <button onclick="window.location.href='M_4_NewRequest.php';">New cases</button>
    ...
    // echo '<script> alert($parameter) </script>';
            $_SESSION['formformUpdate'] = $formId;
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<p>Date of Birth: " . $row["date_of_birth"] . "</p>";
                    ...
                    echo "<br><h2>Give feedback : </h2>";
                   
                    echo '<form action="commentUpdate.php" method="post">';
                    echo '  <input type="text" name="example" id="example" value="" placeholder = "Make comment">';
