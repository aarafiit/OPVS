  ...
  <div class="sidebar">
    ...
    <div class="content">
        <table>
            ...
            $sql1 = "UPDATE form_info SET status = 'Rejected by Institute' WHERE  form_id = $formId;";
            ...
            if ($result->num_rows >= 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // $formId = $row['form_id'];
                    $formIdfordeclineM2 = $row['form_id'];
                    echo "<tr>";
                    echo "<td>" . $row["full_name"] . "</td>";
                    echo "<td>" . $row["date"] . "</td>";
                    echo '<td>
                    <button class="accept-button" style="background-color: green; color: antiquewhite;" onclick = "redirectToAnotherPage1('.$formIdfordeclineM2.')">Accept and send to SB</button>
                    <button class="decline-button" style="background-color: red;" onclick = "redirectToAnotherPage2('.$formIdfordeclineM2.')">Decline</button>
                    <button class="decline-button" style="background-color: black; color : white;" onclick = "redirectToAnotherPage3('.$formIdfordeclineM2.')">View</button>                 
