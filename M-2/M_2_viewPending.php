...
<body>
    ...
    margin-top: 0px;">
        ...
        $sql = "SELECT * FROM form_info WHERE form_id = $formId and (status = 'police' or status = 'sb' or status = 'officer') and institute_email = '$institute'";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<p>Date of Birth: " . $row["date_of_birth"] . "</p>";
                    ...
                    echo "<br><h3>Educational Qualifications</h3>";
                    echo "<table>";
