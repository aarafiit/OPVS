...
<body>
    ...
    <div class="content" style="margin-left : 6%;padding: 110px;margin-top:0%;">
        <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // echo "<p>Joining Id : " . $row["joinig_id"] . "</p>";
                echo "<p>Date of Birth: " . $row["date_of_birth"] . "</p>";
                    ...
                    echo "<br><br>";
                    echo '<button class="accept-button" style="background-color: green; color: antiquewhite;" onclick = "redirectToAnotherPage1('.$formId.')">Accept and send to SB</button>';
                    echo "<br>";
                    echo  '<button class="decline-button" style="background-color: red;" onclick = "redirectToAnotherPage2('.$formId.')">Decline</button>';
